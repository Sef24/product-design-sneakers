  ...
  return (
    <main className=" px-5 lg:border-b-2 border-gray-300 lg:pb-8 lg:mx-32 ">
      <section className="flex items-center justify-between pt-7 ">
        <div className="flex items-center space-x-3">
          <button onClick={() => setOpenMenu(!openMenu)}>
            <img
              src={menu}
              alt=""
              className="h-4 lg:hidden hover:transition
        ...
        <div>
          <ul className="invisible md:visible flex items-center justify-between space-x-4 ">
            <li className="cursor-pointer hover:underline font-bold text-sm">
              Collections
            </li>
            <li className="cursor-pointer hover:underline font-bold text-sm">
              Men
