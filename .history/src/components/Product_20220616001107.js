  ...
  return (
    <div className="">
      <main>
        ...
        md:place-items-center max-w-7xl md:max-w-4xl  lg:mx-auto md:py-10"
        >
          <div
          ...
          <article className="px-5 ">
            ...
            <div>
              <button
               ...
               my-2 border-2 rounded-xl py-4 lg:py-3 px-40 w-full
                bg-gradient-to-r from-pink-300 to-orange-500
                hover:bg-gradient-to-r hover:from-orange-300 hover:to-purple-300
                 translate transition duration-125 active:scale-110"
              >
                <img src={cart} alt="" />
              </button>
            </div>
