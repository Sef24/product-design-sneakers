...
function Product() {
  return (
    <div className="">
      <main>
        <section
          className="flex flex-col-reverse md:grid md:gap-10 lg:gap-28 md:grid-cols-2 
        md:place-items-center max-w-6xl lg:max-w-4xl md:max-w-4xl md:mx-auto md:py-10"
        >
