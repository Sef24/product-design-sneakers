      ...
      <section className="flex items-center justify-between pt-7 ">
        ...
        <div>
          <ul className="hidden md:flex items-center justify-between space-x-4 ">
            <li className="cursor-pointer hover:underline text-xs text-gray-500">
              Collections
            </li>
        ...
        <section className="flex items-center justify-between space-x-6   ">
          <img
            src={cart}
            alt=""
            className="h-5 w-5 hover:scale-105 hover:animate-pulse cursor-pointer"
          />
          <img
            src={avatar}
            alt=""
            className="h-8 hover:animate-pulse cursor-pointer"
          />
        </section>
      </section>
    </main>
