...
function Product() {
  ...
  return (
    <div className="">
      <main>
        <section
          className="flex flex-col items-center justify-center w-full md:grid md:space-x-28 md:mx-10 lg:ml-32 md:grid-cols-2 
          ...
          >
            <div>
              ...
              <div className="flex space-x-4 my-3 px-2">
                <button className="active:border-2 active:border-blue-600 hover:scale-105">
