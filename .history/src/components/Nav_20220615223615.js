      ...
      <section className="flex items-center justify-between pt-7 ">
        ...
        <div>
          <ul className="hidden md:flex items-center justify-between space-x-4 ">
            <li className="cursor-pointer hover:underline text-xs">
              Collections
            </li>
            <li className="cursor-pointer hover:underline text-gray-600 text-xs">
              Men
            </li>
            <li className="cursor-pointer hover:underline  text-xs">Women</li>
            <li className="cursor-pointer hover:underline text-xs">About</li>
            <li className="cursor-pointer hover:underline  text-xs">Contact</li>
          </ul>
        </div>
        {openMenu && (
